...
import 'package:flutter_base_api/client.dart';
import 'package:http/http.dart' as http;

/// {@template flutter_base_api_malformed_response}
/// An exception thrown when there is a problem decoded the response body.
/// {@endtemplate}
class FlutterBaseApiMalformedResponse implements Exception {
  /// {@macro flutter_base_api_malformed_response}
  const FlutterBaseApiMalformedResponse({required this.error});

  /// The associated error.
  final Object error;
}

/// {@template flutter_base_api_request_failure}
/// An exception thrown when an http request failure occurs.
/// {@endtemplate}
class FlutterBaseApiRequestFailure implements Exception {
  /// {@macro flutter_base_api_request_failure}
  const FlutterBaseApiRequestFailure({
...
/// {@template flutter_base_api_client}
/// A Dart API client for the Flutter Base API.
/// {@endtemplate}
class FlutterBaseApiClient {
  /// Create an instance of [FlutterBaseApiClient] that integrates
  /// with the remote API.
  ///
  /// {@macro flutter_base_api_client}
  FlutterBaseApiClient({
  ...
  ///
  /// {@macro flutter_base_api_client}
  FlutterBaseApiClient.localhost({
    required TokenProvider tokenProvider,
    http.Client? httpClient,
  }) : this._(
  ...
  Future<ArticleResponse> getArticle({
    ...
    if (response.statusCode != HttpStatus.ok) {
      throw FlutterBaseApiRequestFailure(
        body: body,
  ...
  Map<String, dynamic> json() {
    try {
      ...
      Error.throwWithStackTrace(
        FlutterBaseApiMalformedResponse(error: error),
        stackTrace,
      );
    }
  }
