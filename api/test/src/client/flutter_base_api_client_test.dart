...
void main() {
  ...
  group('FlutterBaseApiClient', () {
    late http.Client httpClient;
    late FlutterBaseApiClient apiClient;
    ...
    setUp(() {
      ...
      apiClient = FlutterBaseApiClient(
    ...
    group('localhost constructor', () {
      ...
      test('has correct baseUrl', () async {
        ...
        final apiClient = FlutterBaseApiClient.localhost(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => FlutterBaseApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = FlutterBaseApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test(
          'throws FlutterBaseApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<FlutterBaseApiMalformedResponse>()),
        );
      });

      test(
          'throws FlutterBaseApiRequestFailure '
        ...
        expect(
          () => apiClient.getArticle(id: articleId),
          throwsA(
            isA<FlutterBaseApiRequestFailure>()
