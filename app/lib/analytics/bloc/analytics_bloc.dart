...
/// {@template analytics_bloc}
/// A [Bloc] responsible for handling analytics events and updating the
/// analytics state.
/// {@endtemplate}
class AnalyticsBloc extends Bloc<AnalyticsEvent, AnalyticsState> {
/// The [analytics.AnalyticsRepository] instance used for tracking events.
  AnalyticsBloc({
