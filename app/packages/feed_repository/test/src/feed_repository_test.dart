  ...
  group("FeedRepository", () {
    ...
    group("subscribeToNewsletter", () {
      test("completes from ApiClient.subscribeToNewsletter", () {
        ...
        final response = feedRepository.subscribeToNewsletter(email: "email");
    ...
    group("relevantSearch", () {
      test(
        ...
        expect(
          feedRepository.relevantSearch(term: ""),
      ...
      test(
        ...
        expect(
          feedRepository.relevantSearch(term: "term"),
